...
class Mbbs_Plugin_Template {
	...
	/**
	 * Main Mbbs_Plugin_Template Instance
	 *
	 * Ensures only one instance of Mbbs_Plugin_Template is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Mbbs_Plugin_Template()
	 * @return Main Mbbs_Plugin_Template instance
	 */
